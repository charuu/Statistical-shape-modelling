...
object FemurKernel {
    def main(args: Array[String]): Unit = {
        ...
        val scalarValuedGaussianKernel : PDKernel[_3D]= GaussianKernel(sigma = 40.0) * 20.0
        val scalarValuedGaussianKernel1 : PDKernel[_3D]= GaussianKernel(sigma = 40.0) * 20.0
        val scalarValuedGaussianKernel2 : PDKernel[_3D]= GaussianKernel(sigma = 40.0) * 20.0
